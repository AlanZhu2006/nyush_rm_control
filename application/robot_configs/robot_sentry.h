...
// PID参数 - 云台 Yaw
#define GIMBAL_YAW_ANGLE_PID_KP 25.0f
#define GIMBAL_YAW_ANGLE_PID_KI 0.0f
#define GIMBAL_YAW_ANGLE_PID_KD 3.5f
#define GIMBAL_YAW_ANGLE_PID_DEADBAND 0.008f
#define GIMBAL_YAW_ANGLE_PID_INT_LIMIT 100.0f
#define GIMBAL_YAW_ANGLE_PID_MAX_OUT 1000.0f

#define GIMBAL_YAW_SPEED_PID_KP 240.0f
#define GIMBAL_YAW_SPEED_PID_KI 5.0f
#define GIMBAL_YAW_SPEED_PID_KD 15.0f
#define GIMBAL_YAW_SPEED_PID_INT_LIMIT 800.0f
#define GIMBAL_YAW_SPEED_PID_MAX_OUT 28000.0f
