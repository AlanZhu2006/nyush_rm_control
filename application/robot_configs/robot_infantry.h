...
#define SHOOT_FRICTION_R_REVERSE MOTOR_DIRECTION_NORMAL
...
// PID参数 - 云台
#define GIMBAL_YAW_ANGLE_PID_KP 2.5f
#define GIMBAL_YAW_ANGLE_PID_KI 0.0f
#define GIMBAL_YAW_ANGLE_PID_KD 0.34f
#define GIMBAL_YAW_ANGLE_PID_DEADBAND 0.03f
#define GIMBAL_YAW_ANGLE_PID_INT_LIMIT 100.0f
#define GIMBAL_YAW_ANGLE_PID_MAX_OUT 300.0f
...
#define SHOOT_FRICTION_CURRENT_PID_KP 0.5f
#define SHOOT_FRICTION_CURRENT_PID_KI 0.1f
